...
var moisture_loss: float = 0.4 # Min 0.5, Max 8.0 --> 5.5, 3.0, 0.5 --> -0.1 three times
var grow_mod: float = 12.0 # Min 0.5, Max 4.0 --> 2.0, 1.0, 0.5 --> /2 three times
var crop_yield: int = 1 # Min 1, Max 4 --> 2, 3, 4 --> +1 three times ---> need inventory upgrade
var process_speed: float = 12.0 # Min 0.25, Max 2.0 --> 1.0, 0.5, 0.25 --> /2 three times
var cook_speed: float = 12.0 # Min 0.25, Max 2.0 --> "" ""
